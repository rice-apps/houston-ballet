...
export default async function WelcomePage() {
    ...
    return (
        ...
        <div className="flex flex-row h-screen">
            ...
            <div className="h-full w-1/2 flex items-centerå">
                <div className="font-sans text-4xl text-[#423E4C]">Choose Your Interests ...</div>
            </div>
        </div>


        <div className='absolute z-10 right-0'>ååå */
