...
function VendorDescription(props : {description : string}) {
    return (
        <div className="relative flex flex-col text-gray-700 bg-gray-100 shadow-lg w-96 rounded-xl bg-clip-border font-Figtree" aria-labelledby="vendor-description-title">
            <div className="p-6">
