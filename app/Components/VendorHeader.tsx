...
function VendorHeader(props: {
    ...
    return (
        <div className="flex flex-col" role="banner">
            {/* Back button */}
            <div className="relative mb-5 flex flex-row pb-5 pl-10 pt-64">
                <Image
                    priority
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 z-10 flex items-center gap-x-5 px-10 py-5 pt-10">
                    ...
                    <Link
                        href={`/map?location=${props?.mapId} - ${props.vendorName}`}
                    >
                        <button className="focus:shadow-outline inline-flex h-10 items-center rounded-lg bg-slate-700 px-5 text-white transition-colors duration-150 hover:bg-slate-800">
            ...
            {/* Vendor Name */}
            <div
                className="mx-10 flex flex-row gap-x-5"
